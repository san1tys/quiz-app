...
from .views import QuizAPIView, QuizEnrollAPIView, MyQuizzesAPIView, QuizSubmitAPIView, QuizUnenrollAPIView, QuizDetailAPIView, StudentScoresAPIView


urlpatterns = [
    path('quizzes/', QuizAPIView.as_view(), name='quiz-list'),
    path('create/', QuizDetailAPIView.as_view(), name='create-quiz-by-teacher'),
